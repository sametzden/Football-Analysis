...
class CameraMovementEstimator:
    """
    Lucas-Kanade optik akış algoritması ile frame'ler arası
    kamera hareketini (pan/tilt) hesaplar.
    """
    ...
    def __init__(self, frame):
        ...
        # Sadece saha dışı kenarlardan feature noktaları al (reklam panoları vb.)
    ...
    def add_adjust_positions_to_tracks(self, tracks, camera_movement_per_frame):
        """Kamera hareketini telafi ederek pozisyonları düzeltir."""
    ...
    def get_camera_movement(self, frames, read_from_stub=False, stub_path=None):
        """
        Tüm frame'ler üzerinden kamera hareketini hesaplar.
        Döndürdüğü: [[dx, dy], ...] — her frame için kümülatif kamera ofseti.
        """
    ...
    def draw_camera_movement(self, frames, camera_movement_per_frame):
        """Frame'ler üzerine kamera hareket bilgisini çizer."""
        output_frames = []
