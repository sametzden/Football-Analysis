...
class Tracker:
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        tracks ={
            "players": [], # list of dicts, each dict represents a frame and players in that frame with their track ids and bboxes
            "referees": [],
            "ball": []
        }
        ...
        for frame_num, detection in enumerate(detections):
            if detection.boxes is not None:
                ...
                # Convert goolkeeper to player objects
                for object_ind , class_id in enumerate(detection_supervision.class_id):
                    if cls_names[class_id] == "goalkeeper":
                        detection_supervision.class_id[object_ind] = cls_names_inv["player"] # player class id
